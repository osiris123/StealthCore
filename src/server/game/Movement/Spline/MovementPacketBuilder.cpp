...
namespace Movement
{
    ...
    void PacketBuilder::WriteCommonMonsterMovePart(const MoveSpline& move_spline, ByteBuffer& data)
    {
		...
		//  this flag breaks cycle for ground movement, client teleports npc between last and first point instead of using smooth movement
