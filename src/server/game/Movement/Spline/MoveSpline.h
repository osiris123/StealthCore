...
namespace Movement
{
    ...
    public:
        int32 timeElapsed() const { return Duration() - time_passed; }	//  moved to public for waypoint movegen
        int32 timePassed() const { return time_passed; }				//  moved to public for waypoint movegen
