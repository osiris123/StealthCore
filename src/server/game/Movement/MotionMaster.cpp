...
{
	//  Do not allow to initialize any motion generator for dead creatures
...
{
    //  do not allow to move with UNIT_FLAG_DISABLE_MOVE
...
void MotionMaster::MoveFall(uint32 id /*=0*/, bool addFlagForNPC)
{
	...
	else if (_owner->GetTypeId() == TYPEID_UNIT && addFlagForNPC)
	{
