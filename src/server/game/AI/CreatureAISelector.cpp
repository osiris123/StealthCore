...
namespace FactorySelector
{
    CreatureAI* selectAI(Creature* creature)
    {
		...
		//  if we have controlable guardian, define petai for players as they can steer him, otherwise db / normal ai
		//  dont remember why i changed this qq commented out as may break some quests
