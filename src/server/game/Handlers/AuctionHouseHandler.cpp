...
void WorldSession::HandleAuctionListBidderItems(WorldPacket & recvData)
{
    ...
    WorldPacket data(SMSG_AUCTION_BIDDER_LIST_RESULT, (4+4+4)+30000);
    Player* player = GetPlayer();
...
void WorldSession::HandleAuctionListOwnerItemsEvent(WorldPacket & recvData)
{
    ...
    _lastAuctionListOwnerItemsMSTime = World::GetGameTimeMS();
    ...
    WorldPacket data(SMSG_AUCTION_OWNER_LIST_RESULT, (4+4+4)+60000);
