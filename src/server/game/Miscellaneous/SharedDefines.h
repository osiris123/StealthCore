...
enum SpellAttr3
{
    ...
    SPELL_ATTR3_NO_PUSHBACK                      = 0x02000000, // 25 no cause spell pushback ?
...
enum SpellAttr5
{
    ...
    SPELL_ATTR5_SKIP_CHECKCAST_LOS_CHECK         = 0x04000000, // 26
...
enum SpellAttr6
{
    ...
    SPELL_ATTR6_DONT_CONSUME_CHARGES             = 0x00000020, //  5  dont consume proc charges
    ...
    SPELL_ATTR6_LIMIT_PCT_HEALING_MODS           = 0x08000000, // 27  complicated and guessed
    SPELL_ATTR6_UNK28                            = 0x10000000, // 28 Death Grip
    SPELL_ATTR6_LIMIT_PCT_DAMAGE_MODS			 = 0x20000000, // 29  complicated and guessed
...
enum SpellImmunity
{
    ...
    IMMUNITY_ID                    = 6,
	IMMUNITY_ALLOW_ID              = 7                      //  special type of immunity, npc is immune to everything except for those spells id
};
