...
#ifndef STEALTHCORE_GAMEOBJECT_H
#define STEALTHCORE_GAMEOBJECT_H
...
struct GameObjectTemplate
{
    ...
    uint32 GetAutoCloseTime() const
    {
        ...
        return autoCloseTime /* changed to milliseconds/ IN_MILLISECONDS*/;              // prior to 3.0.3, conversion was / 0x10000;
    }
