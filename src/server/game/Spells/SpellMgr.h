...
enum SpellGroupSpecialFlags
{
	...
	SPELL_GROUP_SPECIAL_FLAG_FORCED_STRONGEST	= 0x010, //  specially helpful flag if some spells have different auras, but only one should be present
...
enum SpellGroupStackFlags
{
	...
	SPELL_GROUP_STACK_FLAG_FLAGGED				= 0x04, //  just a marker
