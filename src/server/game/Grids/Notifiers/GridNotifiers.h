    ...
    class GameObjectFocusCheck
    {
        public:
            ...
            bool operator()(GameObject* go) const
            {
				...
				if (!go->isSpawned()) //  dont allow to count deactivated objects
					return false;
        ...
        public:
            ...
            bool operator()(Unit* u)
            {
                if (u->IsAlive() && i_obj->IsWithinDistInMap(u, i_range) && !i_funit->IsFriendlyTo(u) && 
					(i_funit->GetTypeId() != TYPEID_UNIT || !i_funit->ToCreature()->IsAvoidingAOE()))
                    return true;
                else
                    return false;
            }
    ...
    class AnyUnfriendlyNoTotemUnitInObjectRangeCheck
    {
        public:
            ...
            bool operator()(Unit* u)
            {
				...
				if (u->GetTypeId() == TYPEID_UNIT && (u->ToCreature()->IsTotem() || u->ToCreature()->IsTrigger() || u->ToCreature()->IsAvoidingAOE()))
                    return false;
